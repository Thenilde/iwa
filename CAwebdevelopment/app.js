...
router.use(express.static(path.resolve(__dirname, 'CAwebdevelopment'))); //We define the views folder as the one where all static content will be served
...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('StoreCar.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('StoreCar.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('StoreCar.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.cafemenu.section[obj.sec_n].trand.push({'car': obj.car, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('StoreCar.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('StoreCar.xml', function(err, result) {
      ...
      delete result.storecar.section[obj.section].brand[obj.brand];
